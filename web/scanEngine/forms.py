    ...
    engine_name = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                "class": "form-control form-control-lg",
                "id": "scan_engine_name",
                "placeholder": "Motor personalizado"}))
    yaml_configuration = forms.CharField(widget=AceWidget(
        mode="yaml",
        theme="tomorrow_night_eighties",
        width="100%",
    ...
    name = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={'class': 'form-control form-control-lg',
                   'id': 'name',
                   'placeholder': 'Mi impresionante lista de palabras', }))
    short_name = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                'class': 'form-control form-control-lg',
                'id': 'short_name',
                'placeholder': 'miImpresionanteListaDePalabras', }))
    ...
    short_name = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                'class': 'form-control form-control-lg',
                'id': 'short_name',
                'placeholder': 'miIncreíbleConfiguración', }))
    ...
    keywords = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                "class": "form-control form-control-lg",
                "id": "keywords",
                "placeholder": "Palabras clave interesantes",
            }))
...
class ReportForm(forms.ModelForm):
    ...
    company_website = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                "class": "form-control form-control-lg",
                "id": "company_website",
                "placeholder": "Sitio web de la empresa https://company.com",
            }))
    ...
    footer_text = forms.CharField(
        ...
        attrs={
            ...
            "id": "footer_text",
            "aria-label": "switch",
            "placeholder": "Texto de pie de página © su empresa",
        }))
    ...
    name = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                "class": "form-control",
                "id": "tool_name",
                "placeholder": "Mi increíble herramienta"}))
    ...
    description = forms.CharField(
        ...
        widget=forms.Textarea(
            attrs={
                "class": "form-control",
                "id": "tool_description",
                "placeholder": "Explique para qué se utiliza esta herramienta.",
                "rows": 2
            }
        ))
    ...
    install_command = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                "class": "form-control",
                "id": "install_command",
                "placeholder": "Comando de instalación de herramientas"}))
    ...
    update_command = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                "class": "form-control",
                "id": "update_command",
                "placeholder": "Comando de actualización de herramientas"}))
